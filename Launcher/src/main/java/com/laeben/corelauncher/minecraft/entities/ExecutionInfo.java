package com.laeben.corelauncher.minecraft.entities;
...
import com.laeben.corelauncher.minecraft.utils.ArgumentConcat;
...
public class ExecutionInfo{
    ...
    public ExecutionInfo(Version v, Account account, Java java, Path dir, String... args){
        this.version = v;
    ...
    public static ExecutionInfo fromProfile(Profile profile){
        ...
        return new ExecutionInfo(profile.getWrapper().getVersion(profile.getVersionId(), profile.getWrapperVersion()), profile.getUser(), profile.getJava(), profile.getPath(), concat.generate().toArray(new String[0]));
    }
